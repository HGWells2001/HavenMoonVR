...
- `Haven Moon VR Experimental.exe`: compile `src/HavenMoonVR.ExperimentalLauncher.cs` as a Windows executable for .NET Framework 4. Do not embed art extracted from the game.
