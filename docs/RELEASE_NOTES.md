...
- Version 1.2.1 removes the forced cinematic rendering profile and restores the original Haven Moon post-processing, anti-aliasing and quality settings.
- Water4 uses the conservative LOD 200 pass. Its stereo-unsafe LOD 500 screen GrabPass remains disabled together with planar reflection and edge blend.
...
- Keeps Unity's native scene fog and uses Water4's conservative stereo-safe LOD 200 path.
