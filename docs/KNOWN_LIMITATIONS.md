...
- The experimental horizon fix uses the low, non-reflective Water4 shader and disables screen-space edge blending. The ocean remains animated but looks simpler than the original planar-reflection water.
